...
with open(csv_file, mode = "r", newline = "") as file:
    ...
    for i in range(len(sesongdybde)):
        print(f"For sesongen som begynner {aar[i]} er det{len(del1d_returner_liste_av_storre_tall.differanse(sesongdybde[i], 20))} snodager")
